        ...
        httpSecurity
                ...
                .authorizeHttpRequests((authorize) ->
                        authorize
                                ...
                                .requestMatchers("/api/current", "/api/accounts/clients/current", "/api/accounts/clients/current/accounts", "/api/cards/clients/current/cards", "/api/transactions/", "/api/loans/apply", "/api/loans/clientloans").hasRole("CLIENT")
