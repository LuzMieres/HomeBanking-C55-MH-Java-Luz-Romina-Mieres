...
public class LoanServiceTest {
    ...
    public void testApplyForLoan() {
        ...
        Account account = new Account("VIN001", LocalDate.now(), 50000);
        Loan loan = new Loan("Personal", 100000, List.of(12, 24, 36));
        ...
        // Aplicar el préstamo
        loanService.applyForLoan("Personal", 50000, 12, "VIN001", client);

        // Obtener las cuentas con el número "VIN001"
        List<Account> updatedAccounts = accountRepository.findByNumber("VIN001");
